...
public class PPureDatabaclup extends ProtoBase {
    ...
    public void initPatch(String filePath) {
...
//        };
    ...
    public PPureDatabaclup onNewData(final PdPatchCallback callbackfn) {
