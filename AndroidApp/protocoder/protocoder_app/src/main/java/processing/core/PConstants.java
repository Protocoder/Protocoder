...
public interface PConstants {
	...
	/*
	 * static public final int TX = 18; // transformed xyzw static public final
	 * int TY = 19; static public final int TZ = 20;
	 * 
	 * static public final int VX = 21; // view space coords static public final
	 * int VY = 22; static public final int VZ = 23; static public final int VW
	 * = 24;
	 * 
	 * // Ambient color (usually to be kept the same as diffuse) // fill(_) sets
	 * both ambient and diffuse. static public final int AR = 25; static public
	 * final int AG = 26; static public final int AB = 27;
	 * 
	 * // Diffuse is shared with fill. static public final int DR = 3; // TODO
	 * needs to not be shared, this is a material property static public final
	 * int DG = 4; static public final int DB = 5; static public final int DA =
	 * 6;
	 * 
	 * // specular (by default kept white) static public final int SPR = 28;
	 * static public final int SPG = 29; static public final int SPB = 30;
	 * 
	 * static public final int SHINE = 31;
	 * 
	 * // emissive (by default kept black) static public final int ER = 32;
	 * static public final int EG = 33; static public final int EB = 34;
	 */
	...
	static final String[] platformNames = { "other", "windows", "macosx", "linux" };
	 ...
	 * instead. For this reason, be sure to call textMode() <EM>after</EM>
	 * calling textFont().
	 * <p/>
	...
	static final String ERROR_BACKGROUND_IMAGE_SIZE = "background image must be the same size as your application";
	static final String ERROR_BACKGROUND_IMAGE_FORMAT = "background images should be RGB or ARGB";

	static final String ERROR_TEXTFONT_NULL_PFONT = "A null PFont was passed to textFont()";

	static final String ERROR_PUSHMATRIX_OVERFLOW = "Too many calls to pushMatrix().";
	static final String ERROR_PUSHMATRIX_UNDERFLOW = "Too many calls to popMatrix(), and not enough to pushMatrix().";
