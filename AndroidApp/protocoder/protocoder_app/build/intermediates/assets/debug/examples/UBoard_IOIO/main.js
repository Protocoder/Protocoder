...
ui.addButton("Start ioio", 0, 0, ui.screenWidth, 200, function() { 
...
ui.addButton("On", 0, 220, ui.screenWidth / 2, 300, function() { 
   if (ioioConnected == true) led.write(false);
});

ui.addButton("Off", ui.screenWidth / 2, 220, ui.screenWidth / 2, 300, function() { 
      if (ioioConnected == true)   led.write(true);
});


//power off the ioio  
ui.addButton("Stop ioio", 0, 550, ui.screenWidth, 100, function() { 
    if (ioioConnected == true) {
      ioio.stop();
      ioioConnected = false
    }
