...
public class LineStroker {
	 ...
	 * @param transform
	 *            a <code>Transform4</code> object indicating the transform that
	 *            has been previously applied to all incoming coordinates. This
	 *            is required in order to produce consistently shaped end caps
	 *            and joins.
	 */
	public LineStroker(LineStroker output, int lineWidth, int capStyle, int joinStyle, int miterLimit,
			PMatrix2D transform) {
		setOutput(output);
	...
	private void drawRoundJoin(int x, int y, int omx, int omy, int mx, int my, int side, boolean flip, boolean rev,
			long threshold) {
	...
	private void drawMiter(int px0, int py0, int x0, int y0, int x1, int y1, int omx, int omy, int mx, int my,
			boolean rev) {
		if (mx == omx && my == omy) {
			return;
		}
	...
	public void moveTo(int x0, int y0) {
		// System.out.println("LineStroker.moveTo(" + x0/65536.0 + ", " +
		// y0/65536.0 + ")");
	...
	public void lineTo(int x1, int y1) {
		// System.out.println("LineStroker.lineTo(" + x1/65536.0 + ", " +
		// y1/65536.0 + ")");
	...
	private void emitMoveTo(int x0, int y0) {
		// System.out.println("LineStroker.emitMoveTo(" + x0/65536.0 + ", " +
		// y0/65536.0 + ")");
		output.moveTo(x0, y0);
	}

	private void emitLineTo(int x1, int y1) {
		// System.out.println("LineStroker.emitLineTo(" + x0/65536.0 + ", " +
		// y0/65536.0 + ")");
		output.lineTo(x1, y1);
	}
