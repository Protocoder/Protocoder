...
public class OSCPacketCodec {
    ...
    /**
     * Support mode: like <code>MODE_STRICT_V1</code>, but with additional 64bit support, that is a mutual mapping
     ...
     * @param charset
     *            the name of the charset to use for string coding and decoding, like <code>&quot;UTF-8&quot;</code>,
     ...
     * 
     * @param charsetName
     *            the name of the charset, e.g. <code>&quot;UTF-8&quot;</code>, <code>&quot;ISO-8859-1&quot;</code> etc.
     * @see java.nio.charset.Charset
     */
     ...
     * 
     * @param typeTag
     *            the typetag which is to be decoded with the new <code>Atom</code>. <code>typeTag</code> must be in the
     *            ASCII value range 0 to 127.
     * @param a
     *            the decoder to use
     * 
     ...
     * 
     * @param mode
     *            the new mode to use. A flag field combination of <code>MODE_READ_DOUBLE</code> or
     *            <code>MODE_READ_DOUBLE_AS_FLOAT</code> etc., or a ready made combination such as
     ...
     * <code>OSCBundle</code> is called (which may recursively decode nested bundles), otherwise the one from
     * <code>OSCMessage</code>.
     * 
     * @param b
     *            <code>ByteBuffer</code> pointing right at the beginning of the packet. the buffer's limited should be
     *            set appropriately to allow the complete packet to be read. when the method returns, the buffer's
     *            position is right after the end of the packet.
     * 
     ...
     *             in case of a parsing error that causes the method to read past the buffer limit
     ...
     * 
     * @param b
     *            <code>ByteBuffer</code> pointing right at the beginning of the osc packet. buffer position will be
     *            right after the end of the packet when the method returns.
     * 
     * @throws IOException
     ...
     * <code>OSCPacket</code> superclass which will invoke this method of it finds an OSC message.
     * 
     * @param b
     *            ByteBuffer pointing right at the beginning of the type declaration section of the OSC message, i.e.
     *            the name was skipped before.
     * 
     ...
     * @param b
     *            <code>ByteBuffer</code> pointing right at the beginning of the osc packet. buffer position will be
     *            right after the end of the message when the method returns.
     * 
     * @throws IOException
     *             in case some of the writing procedures failed (buffer overflow, illegal arguments).
     */
     ...
     * 
     * @param b
     *            buffer to read from. position and limit must be set appropriately. new position will be right after
