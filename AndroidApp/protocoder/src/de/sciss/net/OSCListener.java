...
/**
 * The <code>OSCListener</code> interface is used to register a client to an
 * <code>OSCReceiver</code> object which will be notified when an incoming
 ...
 * which is not the regular AWT event dispatcher thread. You may often want to
