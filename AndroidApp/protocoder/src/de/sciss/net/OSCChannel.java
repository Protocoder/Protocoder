...
/**
 * A collection of common constants and methods that apply to all kinds of OSC communicators. Formely being abstract
 * superclass <code>AbstractOSCCommunicator</code> of <code>OSCTransmitter</code> and <code>OSCReceiver</code>, the
 * functionality has been reduced and converted to an interface as of v0.30. </P>
 * <P>
 * The method for getting a socket's <code>DatagramChannel</code> has been removed in the course of TCP integration,
 * also with keeping in mind the possible future integration of other channel types such as <code>FileChannel</code> or
 * <code>PipeChannel</code>.
 * 
...
public interface OSCChannel {
    /**
     * Protocol type : user datagram protocol. <A HREF="http://en.wikipedia.org/wiki/User_Datagram_Protocol"
