...
/**
 * Exception thrown by some OSC related methods. Typical reasons are
 * communication timeout and buffer underflows or overflows.
 * 
...
public class OSCException extends IOException {
	...
	private static final String[] errMessages = { "errOSCTimeOut", "errOSCFailed", "errOSCBuffer", "errOSCFormat",
			"errOSCTypeTag", "errOSCArgClass", "errOSCReceive" };

	/**
	 * Constructs a new <code>OSCException</code> with the provided type of
	 * cause (e.g. <code>TIMEOUT</code>) and descriptive message.
	 * 
	 * @param causeType
	 *            cause of the exception
	 * @param message
	 *            human readble description of the exception, may be
	 *            <code>null</code>
	 */
	public OSCException(int causeType, String message) {
		super(NetUtil.getResourceString(errMessages[causeType]) + (message == null ? "" : (": " + message)));
	 ...
	 * 
	 * @return cause of the exception, e.g. <code>BUFFER</code> if a buffer
