...
public class HoloCircleSeekBar extends View {
    ...
    /**
     * {@code true} if the user clicked on the pointer to start the move mode. {@code false} once the user stops
     * touching the screen.
     * 
	...
	mColorWheelStrokeWidth = a.getInteger(R.styleable.HoloCircleSeekBar_wheel_size, 8);
	mPointerRadius = a.getInteger(R.styleable.HoloCircleSeekBar_pointer_size, 32);
