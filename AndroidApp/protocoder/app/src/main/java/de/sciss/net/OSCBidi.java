...
/**
 * An interface describing common functionality in bidirectional OSC
 * communicators.
 * 
...
public interface OSCBidi extends OSCChannel {
	...
	/**
	 * Checks whether the communicator is active (was started) or not (is
	 * stopped).
	 * 
	 * @return <code>true</code> if the communicator is active,
	 ...
	 * incoming messages are not dumped. Incoming messages are those received by
	 * the client from the server, before they get delivered to registered
	...
	/**
	 * Changes the way outgoing messages are dumped to the console. By default
