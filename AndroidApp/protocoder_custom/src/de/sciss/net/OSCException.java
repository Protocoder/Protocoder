...
public class OSCException extends IOException {
    ...
    /**
     * Constructs a new <code>OSCException</code> with the provided type of cause (e.g. <code>TIMEOUT</code>) and
     * descriptive message.
     * 
     * @param causeType
     *            cause of the exception
     * @param message
     *            human readble description of the exception, may be <code>null</code>
     */
     ...
     * 
     * @return cause of the exception, e.g. <code>BUFFER</code> if a buffer underflow or overflow occured
     */
