...
public class OSCMessage extends OSCPacket {
     ...
     *            the OSC command, like "/s_new"
     * @param args
     *            array of arguments which are simply assembled. Supported types are <code>Integer</code>,
     ...
     * 
     * @param index
     *            index of the argument, beginning at zero, must be less than <code>getArgCount()</code>
     * 
