...
public class MWMActivity extends BaseActivity implements HardwareCallback {
	...
	private static final int TOGGLE_EDITOR = 235;
	...
	public void onResume() {
		...
		//Set actionbar text
		if (project.getName() != null) getActionBar().setTitle(project.getName());
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
	    //menu.clear();
		menu.add(0, TOGGLE_EDITOR, 0, "Source").setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
