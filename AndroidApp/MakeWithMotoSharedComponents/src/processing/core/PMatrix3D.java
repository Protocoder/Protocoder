...
//  }
  ...
  public void rotateZoptim(float angle) {
    float c = (float)Math.cos(angle);//cos(angle);
    float s = (float)Math.sin(angle);//sin(angle);
    applyRotateZOptim( //
          c, -s,//  0,  0, //  
          s,  c);//,  0,  0, // 
          //0,  0,  1,  0, // 
      ...
      ) // 
  {
    ...
    //float r02 = /* m00*n02 + m01*n12 + */ m02;// + m03*n32;
    //float r03 = /* m00*n03 + m01*n13 + m02*n23 + */ m03;
    
    float r10 = m10*n00 + m11*n10; // + m12*n20 + m13*n30;
    float r11 = m10*n01 + m11*n11; // + m12*n21 + m13*n31;
    //float r12 = /* m10*n02 + m11*n12 + */ m12;// + m13*n32;
    //float r13 = /* m10*n03 + m11*n13 + m12*n23 + */ m13;
    
    float r20 = m20*n00 + m21*n10; // + m22*n20 + m23*n30;
    float r21 = m20*n01 + m21*n11; // + m22*n21 + m23*n31;
    //float r22 = /* m20*n02 + m21*n12 + */ m22;// + m23*n32;
    //float r23 = /* m20*n03 + m21*n13 +  m22*n23 + */ m23;
    
    float r30 = m30*n00 + m31*n10; // + m32*n20 + m33*n30;
    float r31 = m30*n01 + m31*n11; // + m32*n21 + m33*n31;
    //float r32 = /* m30*n02 + m31*n12 + */ m32;// + m33*n32;
    //float r33 = /* m30*n03 + m31*n13 + m32*n23 + */ m33;
  ...
  public void preApplyZOptim( //
      float n00, float n01, //float n02, float n03,
      float n10, float n11, //float n12, float n13,
      /*float n20, float n21,*/ float n22//, float n23,
      /*float n30, float n31, float n32, float n33 = 1*/) 
  {
    ...
    //float r30 = /*n30*m00 + n31*m10 + n32*m20 +*/ m30;
    //float r31 = /*n30*m01 + n31*m11 + n32*m21 +*/ m31;
    //float r32 = /*n30*m02 + n31*m12 + n32*m22 +*/ m32;
    //float r33 = /*n30*m03 + n31*m13 + n32*m23 +*/ m33;
