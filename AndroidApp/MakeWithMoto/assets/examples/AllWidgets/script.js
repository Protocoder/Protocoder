...
ui.circularSeekbar(0, 2500, 350, 350, function(val) {
    console.log(val);
});

//Add a seekbar
ui.seekbar(0, 150, 500, 100, 100, 50, function(val) { 
    console.log(val);
});
...
//Add an edit text
ui.input("Type something here", 0, 450, 500, 100, function(val){ 
    console.log(val);
});

//Add a toggle button
ui.toggleButton("I'm toggleable", 0, 600, 500, 100, true, function(val) { 
    console.log(val);
});

//Add a checkbox
ui.checkbox("Check me out bro", 0, 750, 500, 100, true, function(val) { 
    console.log(val);
});

//Add a radio
ui.radiobutton("Why am I called a radio button", 0, 900, 500, 100, true, function(val){ 
    console.log(val);
});
...
ui.imagebutton(400, 1050, 300, 300,"makewithmotologo.png", false, function(val){ 
    console.log(val); 
});
...
//Add an image loaded from the web
ui.toggleswitch(0, 2000, 500, 100, true, function(val){ 
    console.log(val);
});
