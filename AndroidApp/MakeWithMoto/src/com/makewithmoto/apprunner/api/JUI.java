...
public class JUI extends JInterface {
	...
	public void showToast(final String text, final String duration) {
		/*
		 * if (duration.equalsIgnoreCase("long")) {//HSHIEH: Please use the
		 * correct string for duration. In my opinion it should either be "LONG"
		 * or "LENGTH_LONG" Toast.makeText(c.get(), text,
		 * Toast.LENGTH_LONG).show(); } else { Toast.makeText(c.get(), text,
