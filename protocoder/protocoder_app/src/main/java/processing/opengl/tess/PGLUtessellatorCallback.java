...
public interface PGLUtessellatorCallback {
	 ...
	 * the <b>GLU_TESS_BOUNDARY_ONLY</b> property is set to <b>GL_FALSE</b>,
	 * then the argument is set to either <b>GL_TRIANGLE_FAN</b>,
	 ...
	 * 
	 * @param type
	 *            Specifics the type of begin/end pair being defined. The
	 *            following values are valid: <b>GL_TRIANGLE_FAN</b>,
	 *            <b>GL_TRIANGLE_STRIP</b>, <b>GL_TRIANGLES</b> or
	 *            <b>GL_LINE_LOOP</b>.
	 * 
	 ...
	 * opaque reference provided when {@link PGLU#gluTessBeginPolygon
	 ...
	 * {@link javax.media.opengl.GL#glEdgeFlag glEdgeFlag}. The method takes a
	 * single boolean boundaryEdge that indicates which edges lie on the polygon
	 * boundary. If the boundaryEdge is <b>GL_TRUE</b>, then each vertex that
	 ...
	 * it takes an additional reference argument. This reference is identical to
	 * the opaque reference provided when {@link PGLU#gluTessBeginPolygon
	 * gluTessBeginPolygon} was called.
	 * 
	 * @param boundaryEdge
	 *            Specifics which edges lie on the polygon boundary.
	 ...
	 * begin} and {@link #end end} callback methods. It is similar to
	 * {@link javax.media.opengl.GL#glVertex3f glVertex3f}, and it defines the
	 * vertices of the triangles created by the tessellation process. The method
	 * takes a reference as its only argument. This reference is identical to
	 * the opaque reference provided by the user when the vertex was described
	 * (see {@link PGLU#gluTessVertex gluTessVertex}).
	 * 
	 * @param vertexData
	 ...
	 * takes an additional reference argument. This reference is identical to
	 * the opaque reference provided when {@link PGLU#gluTessBeginPolygon
	 * gluTessBeginPolygon} was called.
	 * 
	 * @param vertexData
	 ...
	 * reference provided when {@link PGLU#gluTessBeginPolygon
	 * gluTessBeginPolygon} was called.
	 * 
	 * @param polygonData
	 *            Specifics a reference to user-defined data.
	 ...
	 * The method takes four arguments: an array of three elements each of type
	 ...
	 * {@link PGLU#gluTessEndPolygon gluTessEndPolygon} is called.
	 * <P>
	 * 
	 ...
	 * callback might look like this: </UL>
	 * 
	 * <PRE>
