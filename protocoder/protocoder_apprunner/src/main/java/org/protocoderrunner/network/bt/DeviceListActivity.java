...
public class DeviceListActivity extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		// Setup the window
		v = inflater.inflate(R.layout.bt_device_list, container);
		...
		mPairedDevicesArrayAdapter = new ArrayAdapter<String>(getActivity(), R.layout.bt_device_name);
		mNewDevicesArrayAdapter = new ArrayAdapter<String>(getActivity(), R.layout.bt_device_name);
		...
		// If there are paired devices, addPE each one to the ArrayAdapter
	...
	private void doDiscovery() {
		...
		v.findViewById(R.id.new_devices).setVisibility(View.VISIBLE);
